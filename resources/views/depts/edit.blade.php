                                ...
                                <div class=" tab-menu-heading">
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            <li><a href="#tab4" class="nav-link active" data-toggle="tab">تعديل  قسم</a></li>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        <td> {{ Form::submit('حفظ', ['class'=>'btn btn-success btn-block'] )}}</td>
                                                         <td> {{ Html::linkRoute('depts.show','الغاء',array($dept->id),array('class'=>'btn btn-danger btn-block')) }}</td>
                                                          <td>
