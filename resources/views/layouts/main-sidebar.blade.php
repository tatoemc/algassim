        ...
        @can('sponsor-list')
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">اوياء الامور</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('sponsors.create') }}">اضافة ولي امر</a></li>
                    <li><a class="slide-item" href="{{ route('sponsors.index') }}">عرض اوليا الامور</a></li>
                </ul>
         ...
         @can('guardian-list')
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الكافلين</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
               
                    <li><a class="slide-item" href="{{ route('guardians.create') }}">اضافة كافل</a></li>
                
                    <li><a class="slide-item" href="{{ route('guardians.index') }}">عرض الكافلين</a></li>
                </ul>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الكفالة</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('sponserforms.create') }}">اضافة كفالة</a></li>
                    <li><a class="slide-item" href="{{ route('sponserforms.index') }}">عرض الكفالة</a></li>
                </ul>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">الايتام</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('orphans.index') }}"> عرض الايتام</a></li>
                    <li><a class="slide-item" href="{{ route('orphans.create') }}">اضافة يتم</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('reports.index') }}">الايتام</a></li>
                    <li><a class="slide-item" href="{{ url('usereport') }}">الكافلين</a></li>
                     <li><a class="slide-item" href="{{ url('sponsorsreport') }}">اوياء الامور</a></li>
                </ul>
            </li>
      @can('guardian-list')
            <li class="slide">
       ...
       @endcan
        ...
        <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('students.index') }}">قائمة الطلاب</a></li>
                    <li><a class="slide-item" href="{{ route('students.create') }}">انشاء طالب</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'roles')) }}">صلاحيات
                            المستخدمين</a></li>
                </ul>
            </li>
        ...
        <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-5 7c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10zM4.59 11.59l-.59.58V4h11v7H5.17l-.58.59z" />
                    </svg><span class="side-menu__label">الدفعيات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('payments.index') }}">عرض الدفعيات</a></li>
                </ul>
            </li>
