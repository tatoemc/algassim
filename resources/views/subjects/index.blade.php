...
@section('content')
   @if (session()->has('subject_add'))
    ...
    @endif
     ...
     @if (session()->has('edit_subject'))
        <script>
            window.onload = function() {
                notif({
                    msg: "تم تعديل المادة بنجاح",
                    type: "success"
                })
            }
        </script>
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                 <div class="card-header pb-0">
                        <a href="{{ route('subjects.create') }}" class="btn btn-sm btn-primary" style="color:white"><i
                                class="fas fa-plus"></i>&nbsp; اضافة مادة  </a>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                            <thead>
                                <tr>
                                    <th class="border-bottom-0">رقم المادة</th>
                                    <th class="border-bottom-0"> اسم المادة</th>
                                    <th class="border-bottom-0"> القسم</th>
                                    <th class="border-bottom-0">عدد الساعات</th>
                                        ...
                                        <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu tx-13">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href=" {{ route('subjects.show', $subject->id) }}"><i
